...
public class RangeTest {
	...
	// Boundary Valye Analysis: Test shifting with Double.MAX_VALUE, allow zero
	// crossing
	@Test
	...
	// New tests for A4 to increase mutations killed by 10%

	// false intersection instead of true
	@Test
	public void testIntersectsRangeObjectFalse() {
		Range r1 = new Range(1.0, 5.0);
		Range r2 = new Range(6.0, 8.0);
		assertFalse(r1.intersects(r2));
	}

	// exact value test
	@Test
	public void testHashCodeExactValue() {
		Range r = new Range(1.0, 5.0);
		assertEquals(2118385664, r.hashCode());
	}

	// different lower bound test
	@Test
	...
	@Test(expected = IllegalArgumentException.class)
	public void testShiftNullBaseDefaultOverload() {
		Range.shift(null, 1.0);
	}

	// negative range shifted positively without crossing zero
	@Test
	public void testShiftNegativeRangePositiveDeltaNoZeroCrossing() {
	...
	// intersection symmetry test
	@Test
	public void testIntersectsSymmetry() {
		Range r1 = new Range(1.0, 5.0);
	...
	public void testScaleZero() {
		...
		assertEquals(0.0, scaled.getLowerBound(), 0.000000001d);
		assertEquals(0.0, scaled.getUpperBound(), 0.000000001d);
	}

	// expand to one point
	@Test
	public void testExpandToSinglePoint() {
		Range r = new Range(2.0, 6.0);
		Range expanded = Range.expand(r, -0.5, -0.5);
		assertEquals(4.0, expanded.getLowerBound(), 0.000000001d);
		assertEquals(4.0, expanded.getUpperBound(), 0.000000001d);
	...
	// shift over zero, clipped by boths dies
	@Test
	public void testShiftCrossingZeroClippedBothSides() {
		Range r = new Range(-2.0, 2.0);
		Range shifted = Range.shift(r, -5.0, false);
		assertEquals(-7.0, shifted.getLowerBound(), 0.000000001d);
		assertEquals(0.0, shifted.getUpperBound(), 0.000000001d);
	}

	// The following tests did not improve mutation kill %
	...
	// Intersects range contains reversed
	@Test
	public void testIntersectsRangeContainedReverse() {
	...
	public void testExpandZeroMargins() {
		Range r = new Range(2.0, 6.0);
		Range expanded = Range.expand(r, 0.0, 0.0);
		assertEquals(2.0, expanded.getLowerBound(), 0.000000001d);
		assertEquals(6.0, expanded.getUpperBound(), 0.000000001d);
	}

	// negative range without crossing shift test
	@Test
	public void testShiftNegativeRangeNoCrossingClipsToZero() {
